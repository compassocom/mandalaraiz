...
export class TokenService {
    ...
    async canEarnDailySeeds(userId) {
        ...
        const earned = parseFloat(seedsEarnedToday?.total || '0');
        return {
    ...
    async awardSeeds(userId, amount, description) {
    ...
    async convertSeedsToRoots(userId, seedsAmount) {
    ...
    async transferSeeds(fromUserId, toUserId, amount, description) {
    ...
    async getTokenStatistics() {
        ...
        const totalBurned = await db
            ...
            .executeTakeFirst();
        return {
            total_seeds_in_circulation: parseFloat(totalSeeds?.total || '0'),
            total_roots_in_circulation: parseFloat(totalRoots?.total || '0'),
            total_seeds_burned: parseFloat(totalBurned?.total || '0'),
